    ...
    class ShowRankPlugIn {
        ...
        trial(display_element, trial) {
            ...
            switch (dt.trial_type) {
                case 'Gamble':
                    trial.pS=updatePeformanceGam(trial.pS, dt)
                    console.log('Updated Performance Score',trial.pS)
                    out = refreshBoard(trial.pS)
                    break;
                case 'Math':
                    trial.pS=updatePeformanceGam(trial.pS, dt)
                    console.log('Updated Performance Score',trial.pS)
                ...
                ani2.then(() => {
                    ...
                    an2.then(()=> {
                        ...
                        if (trial.mePos > trial.targetPos) {
                            ...
                            for (ix = trial.targetPos; ix < 11; ix++) {
                            ...
                            for (iy = trial.mePos+1; iy <= trial.targetPos; iy++) {
...
function calScoreGam(dt) {
    ...
    return Math.round((score + Number.EPSILON) * 2)
}

function updatePeformanceGam(pS, dt) {
